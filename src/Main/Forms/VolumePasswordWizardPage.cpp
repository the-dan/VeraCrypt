...
namespace VeraCrypt
{
	...
	{
		PasswordPanel = new VolumePasswordPanel (this, NULL, password, true, keyfiles, ApplyMode::CREATE, false, true, true, enableConfirmation, !enableConfirmation, !enableConfirmation);
